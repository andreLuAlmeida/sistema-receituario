    ...
    <div class="container-fluid py-1 px-3">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
          ...
          <li class="breadcrumb-item text-sm text-dark active" aria-current="page"><a href="{{route('receita.show', $receita->token)}}">Receita</a></li>
        </ol>
        <h6 class="font-weight-bolder mb-0">Detalhes da receita</h6>
      </nav>
...
@endif
    <div class="text-center d-flex justify-content-center">
        ...
        <form id="enviarEmailForm" action="{{ route('enviar-qr-code', [$receita->token, $paciente->id]) }}" method="POST">
            @csrf
            <button type="submit" class="btn btn-primary ml-2">Enviar para o Paciente</button>
        </form>
    </div>    
