    ...
    <div class="container-fluid py-1 px-3">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page"><a href="{{route('admin.farmacias')}}">Farmacias</a></li>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-8">
                        <div class="card z-index-0">
                            <div class="card-body">
                                <form class="row g-3" action="{{ route('update.farmacia', $farmacia->id) }}" method="POST">
                                    @csrf
                                    @method('PUT') 
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select id="estado" class="form-select @error('estado') is-invalid @enderror" name="estado">
                                            <option value="{{$farmacia->estado}}" selected>{{$farmacia->estado}}</option>
