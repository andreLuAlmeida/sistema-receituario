...
<body class="">
  ...
  <main class="main-content  mt-0">
    <section class="min-vh-100 mb-8">
      <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style="background-image: url('{{ asset('template/assets/img/curved-images/maos-da-medica-irreconhecivel-escrevendo-no-formulario-e-digitando-no-teclado-do-laptop.jpg') }}');">
        <span class="mask bg-gradient-dark opacity-6"></span>
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-5 text-center mx-auto">
              <h1 class="text-white mb-2 mt-5">Bem-vindo ao Cadastro de Médico!</h1>
              <p class="text-lead text-white">Aqui você pode criar receitas totalmente digitais e com certificação <br>
              Para isso basta <b>preencher o formulário a seguir com seus dados e aguardar a aprovação</b> da sua conta por nossa equipe!</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row mt-lg-n10 mt-md-n11 mt-n10">
          <div class="col-xl-8 col-lg-10 col-md-7 mx-auto">
            <div class="card z-index-0">
              <div class="card-body">
                <form class="row g-3" method="POST" action="{{ route('register.medico') }}">
                  @csrf
                  ...
                  <div class="col-6">
                      ...
                      <input type="text" class="form-control @error('consultorio_clinica') is-invalid @enderror" id="consultorio_clinica" name="consultorio_clinica" value="{{ old('consultorio_clinica') }}">
                  ...
                  <div class="col-md-4">
                      ...
                      <input type="text" class="form-control @error('crm') is-invalid @enderror" id="crm" placeholder="xxxxxxxx" name="crm" value="{{ old('crm') }}">
                      @error('crm')
                          <div class="invalid-feedback">
                              {{ $message }}
                          </div>
                  ...
                  <div class="col-md-8">
                      ...
                      <input type="text" class="form-control @error('especialidade') is-invalid @enderror" id="especialidade" placeholder="Digite sua especialidade" name="especialidade" value="{{ old('especialidade') }}">
                      @error('especialidade')
                          <div class="invalid-feedback">
                              {{ $message }}
                          </div>
                  ...
                  <div class="col-md-4">
                      ...
                      <select id="estado" class="form-select @error('estado') is-invalid @enderror" name="estado" value="{{ old('estado') }}">
                  ...
                  <div class="col-12">
                      <button type="submit" class="btn btn-primary w-100 mt-2">Solicitar Cadastro</button>
                  </div>
              </form>              
              </div>
            </div>
